...
Four substantive problems arose during development. Each is recorded with its
...
Automation & GitHub Actions, validated before deploy \\
\bottomrule
\end{tabular}
\end{table}
...
resolution, metadata validation and credential hygiene. The two-job validation
gate proved its value on five separate occasions.
